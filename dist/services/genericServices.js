...
var _updateAuthTokenApi = require("./api/auth/updateAuthTokenApi");
...
axiosInstanceToken.interceptors.request.use(function (config) {
  ...
  var token = (0, _utils.getDataFromStorage)("onlusToken");
  if (token) {
    config.headers = {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            (0, _utils.setDataInStorage)("onlusToken", token);
            (0, _utils.setDataInStorage)("onlusRefreshToken", refreshToken);
