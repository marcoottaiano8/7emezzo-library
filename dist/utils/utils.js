...
//chiedo i dati al DB
function getDataFromStorage(_x) {
  return _getDataFromStorage.apply(this, arguments);
} //inserisco i dati nel DB
function _getDataFromStorage() {
  _getDataFromStorage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(key) {
    var users;
...
function setDataInStorage(_x2, _x3) {
  return _setDataInStorage.apply(this, arguments);
} //generic api function
function _setDataInStorage() {
  _setDataInStorage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(users, key) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            _context2.prev = 4;
            _context2.next = 7;
            return _asyncStorage.default.setItem(key, JSON.stringify(users));
          case 7:
            _context2.next = 12;
            break;
          case 9:
...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(apiFunc) {
    var params,
      body,
      _args3 = arguments;
